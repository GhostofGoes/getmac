...
latex_documents = [
    (master_doc, 'get-mac.tex', 'Python package to get MAC addresses',
...
man_pages = [
    (master_doc, 'get-mac', 'Cross-platform tool to get MAC addresses',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'get-mac', 'get-mac Documentation',
     author, 'get-mac', 'Python package to get MAC addresses',
     'Miscellaneous'),
]
