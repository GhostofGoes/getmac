...
latex_documents = [
    (master_doc, 'getmac.tex', 'Python package to get MAC addresses',
...
texinfo_documents = [
    (master_doc, 'getmac', 'getmac Documentation',
     author, 'getmac', 'Python package to get MAC addresses',
     'Miscellaneous'),
]
